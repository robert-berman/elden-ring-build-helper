...
import { editCharacter, fetchSingleCharacter } from '../store/characters';
...
const EditCharacter = (props) => {
  ...
  const [str, setStr] = React.useState(character.str);
  const [dex, setDex] = React.useState(character.dex);
  const [int, setInt] = React.useState(character.int);
  const [fth, setFth] = React.useState(character.fth);
